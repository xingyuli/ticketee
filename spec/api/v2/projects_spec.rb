...
RSpec.describe '/api/v2/projects', type: :api do
  ...
  context 'projects viewable by this user' do
    ...
    it 'JSON' do
      ...
      expect(projects.any? { |p| p['title'] == project.title }).to be_truthy
      expect(projects.any? { |p| p['name'].blank? }).to be_truthy
    end
    ...
    it 'XML' do
      ...
      expect(projects.css('project name').text).to eql('')
    end
  end
  ...
  context 'creating a project' do
    ...
    it 'successful JSON' do
      ...
      expect(last_response.headers['Location']).to eql("/api/v2/projects/#{project.id}")
